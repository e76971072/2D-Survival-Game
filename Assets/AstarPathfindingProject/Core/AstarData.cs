...
namespace Pathfinding
{
    ...
    public class AstarData
    {
        ...
        {
            return SerializeGraphs(Serialization.SerializeSettings.Settings);
        }
        ...
        /// </summary>
        public byte[] SerializeGraphs(Serialization.SerializeSettings settings)
        {
            uint checksum;
        ...
        {
            var graphLock = AssertSafe();
            var sr = new Serialization.AstarSerializer(this, settings);
        ...
        public void DeserializeGraphsAdditive(byte[] bytes)
        {
            ...
            try
            {
                if (bytes != null)
                {
                    var sr = new Serialization.AstarSerializer(this);
        ...
        private void DeserializeGraphsPartAdditive(Serialization.AstarSerializer sr)
        {
