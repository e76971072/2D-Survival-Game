...
namespace Pathfinding
{
    ...
    public abstract class AIBase : VersionedMonoBehaviour
    {
        ...
        protected virtual bool shouldRecalculatePath => Time.time - lastRepath >= repathRate &&
                                                        !waitingForPathCalculation && canSearch &&
        ...
        protected virtual void Update()
        {
            ...
            usingGravity = !(gravity == Vector3.zero) &&
                           (!updatePosition || (rigid == null || rigid.isKinematic) &&
        ...
        protected Quaternion SimulateRotationTowards(Vector2 direction, float maxDegrees)
        {
            ...
            {
                var targetRotation = Quaternion.LookRotation(movementPlane.ToWorld(direction, 0),
