...
namespace Pathfinding
{
    ...
    public class AILerp : VersionedMonoBehaviour, IAstarAI
    {
        ...
        public Quaternion rotation => updateRotation ? tr.rotation : simulatedRotation;
        ...
        Vector3 IAstarAI.velocity => Time.deltaTime > 0.00001f
        ...
        Vector3 IAstarAI.desiredVelocity => (this as IAstarAI).velocity;
        ...
        protected virtual bool shouldRecalculatePath => Time.time - lastRepath >= repathRate && canSearchAgain &&
                                                        canSearch && !float.IsPositiveInfinity(destination.x);
