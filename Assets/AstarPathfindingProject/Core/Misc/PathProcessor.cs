...
namespace Pathfinding
{
    ...
    public class PathProcessor
    {
        ...
        internal PathProcessor(AstarPath astar, PathReturnQueue returnQueue, int processors, bool multithreaded)
        {
            ...
            if (processors < 0) throw new System.ArgumentOutOfRangeException("processors");
        ...
        {
            if (!locks.Remove(id)) throw new System.ArgumentException("This lock has already been released");
        ...
        private void CalculatePathsThreaded(PathHandler pathHandler)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (pathHandler.threadID > 0) throw new System.Exception("Thread Error");
