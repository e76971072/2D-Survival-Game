        ...
        public static void GetContours(INavmesh navmesh, System.Action<List<Int3>, bool> results)
        {
            ...
            navmesh.GetNodes(_node =>
            {
                ...
                if (node != null)
                {
                    ...
                    for (var j = 0; j < 3; j++) // The edge is not shared with any other node
                                ...
                                !seenStates.Contains(startState))
                            {
                                ...
                                while (true)
                                {
                                    ...
                                    if (neighbour == null || nodeSet != null && !nodeSet.Contains(neighbour))
                                    {
                                        ...
                                        graphSpacePos.x +=
                                            (neighbourXOffsets[d0] + neighbourXOffsets[d1]) * offsetMultiplier;
                                        graphSpacePos.z +=
                                            (neighbourZOffsets[d0] + neighbourZOffsets[d1]) * offsetMultiplier;
