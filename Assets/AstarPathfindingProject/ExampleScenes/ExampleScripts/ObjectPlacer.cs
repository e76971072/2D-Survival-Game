...
namespace Pathfinding.Examples
{
    ...
    public class ObjectPlacer : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (Input.GetKeyDown("p")) PlaceObject();

            if (Input.GetKeyDown("r")) StartCoroutine(RemoveObject());
        }
        ...
        public void PlaceObject()
        {
            ...
            {
                var p = hit.point;
                var obj = Instantiate(go, p, Quaternion.identity) as GameObject;
                ...
                if (issueGUOs)
                {
                    ...
                    if (direct) AstarPath.active.FlushGraphUpdates();
                }
            }
        }
