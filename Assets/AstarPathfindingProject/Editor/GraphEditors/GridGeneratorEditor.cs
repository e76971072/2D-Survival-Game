...
namespace Pathfinding
{
    ...
    public class GridGraphEditor : GraphEditor
    {
        ...
        private static readonly float standardIsometric = 90 - Mathf.Atan(1 / Mathf.Sqrt(2)) * Mathf.Rad2Deg;
        private static readonly float standardDimetric = Mathf.Acos(1 / 2f) * Mathf.Rad2Deg;
        ...
        private static bool Is2D(GridGraph graph)
        {
        ...
        protected virtual void Draw2DMode(GridGraph graph)
        {
            ...
            var new2D = EditorGUILayout.Toggle(new GUIContent("2D"), Is2D(graph));
        ...
        private static readonly Vector3[] handlePoints = new[]
        {
