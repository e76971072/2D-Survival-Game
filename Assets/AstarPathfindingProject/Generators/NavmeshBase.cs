...
namespace Pathfinding
{
    ...
    public abstract class NavmeshBase : NavGraph, INavmesh, INavmeshHolder, ITransformedGraph
    {
        ...
        public void RelocateNodes(GraphTransform newTransform)
        {
            ...
            if (tiles != null) // Move all the vertices in each tile
            ...
            for (var i = 0; i < nodes.Length; i++)
            {
                ...
                for (var a = 0; a < av; a++)
                {
                    ...
                    if (nodeRefs.TryGetValue(new Int2(second, first), out connNode))
                    {
                        ...
                        for (var b = 0;
                            b < bv;
                            b++) /// <summary>TODO: This will fail on edges which are only partially shared</summary>
                        ...
                        for (var j = 0; j < numCloseToEdge; j++)
                        {
                            ...
                            for (var b = 0; b < bVertexCount; b++)
                            {
                                    ...
                                    Math.Abs(bVertex2[coord] - midpoint) < 2)
                                {
                                    ...
                                    if (maxalt > minalt2 && minalt < maxalt2) // The two nodes seem to be adjacent
        ...
        protected override void SerializeExtraInfo(GraphSerializationContext ctx)
        {
            ...
            for (var x = 0; x < tileXCount; x++)
            {
                ...
                if (tile == null) throw new System.Exception("NULL Tile");
                //writer.Write (-1);
                //continue;
