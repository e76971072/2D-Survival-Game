    ...
    public class RetainedGizmos
    {
        ...
        public struct Hasher
        {
            ...
            public Hasher(AstarPath active)
            {
                ...
                includePathSearchInfo = debugData != null &&
                                        (active.debugMode == GraphDebugMode.F || active.debugMode == GraphDebugMode.G ||
                                         active.debugMode == GraphDebugMode.H || active.showSearchTree);
